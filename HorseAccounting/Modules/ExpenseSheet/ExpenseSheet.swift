        ...
        NavigationView {
            ...
            .navigationBarItems(
                ...
                HStack {
                    ...
                    }) { Text(RacoonSheetConfig.shared.isEditMode ? "删除" : "清除").bold().foregroundColor(Color(hex:0x093C89)) }
                },
                // 右边有一个按钮
                trailing:
                Button(action: {
                ...
                }) { Text(RacoonSheetConfig.shared.isEditMode ? "修改" : "记账").bold().foregroundColor(Color(hex:0x093C89)) }
            )
        }
        // 发生错误的提示错误
...
//        ExpenseSheet()
//            .environmentObject(PreviewUse.shared.previewCoreDataStack)
